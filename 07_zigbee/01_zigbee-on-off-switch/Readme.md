# 01_zigbee-on-off-switch

The `Zigbee_On_Off_Switch` directory contains basically a clone of the example sketch from the `esp32` Arduino core version 3.3.5 with slight adjustments to support the XIAO ESP32C5 and XIAO ESP32C6 boards.
