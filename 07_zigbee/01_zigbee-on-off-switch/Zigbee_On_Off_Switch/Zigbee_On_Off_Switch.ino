 ...
 *---------------------------------------------------------------------------------------
 *
 * Slightlty modified to support the XIAO ESP32C6 and XIAO ESP32C5 and
 * perhaps boards based on the ESP32-H2, ESP32-C6 and ESP32-C5 SoCs.
 * Also supports the XIAO ESP32C6 external antenna if used.
 *
